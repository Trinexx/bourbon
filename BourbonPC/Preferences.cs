    ...
    public partial class Preferences : Form
    {
        ...
        public static void SelfRelocate()
        {
            try {
                ...
                string ShortcutTarget = Path.Combine(Settings.GamePath, "Bourbon.exe");

                MyToolkit.ActivityLog("Self Relocating Bourbon to \"" + ShortcutTarget + "\"");
                ...
                try {
                    ...
                    try { File.Move(Application.ExecutablePath, Path.Combine(Application.StartupPath, "deleteme.txt")); }
                        ...
                        MyToolkit.ActivityLog("Failed to relocate Bourbon to \"" + ShortcutTarget + "\"");  
                    }
                }
                ...
                try {
                    using (ShellLink shortcut = new ShellLink()) {
                        ...
                        shortcut.Save(Path.Combine(ShortcutPath, "Bourbon.lnk"));
                    }
                } catch (Exception ex) {
